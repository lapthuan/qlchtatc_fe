	...
	return (
		<header className="header">
			<nav className="navbar navbar-toggleable-md navbar-light pt-0 pb-0 ">
				<button className="navbar-toggler navbar-toggler-right" onClick={() => toggleSidebar()} type="button" data-toggle="collapse"
					data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false"
					aria-label="Toggle navigation">
					<span className="navbar-toggler-icon"></span>
				</button>

				<div className="float-left" onClick={() => toggleSidebar()}>   <span className="fa fa-fw fa-bars "></span> </div>
											...
											<li>
												...
												<a href="#">
													<div className="pull-left">
														<img src="http://via.placeholder.com/160x160" className="rounded-circle  "
															alt="User Image" />
													</div>
													<h4>
														Support Team
								...
								<ul className="dropdown-menu-over list-unstyled">
									...
									<li>
										...
										<ul className="menu list-unstyled">
											...
											<li>
												<a href="#">
													<i className="fa fa-warning text-yellow"></i> Very long description here that
